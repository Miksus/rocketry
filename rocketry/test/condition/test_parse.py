...
cases_time = [
    ...
    # Time delta
    pytest.param("every 1 hours", TaskStarted(period=TimeDelta("every 1 hours")) == 0, id="every hour"),
    pytest.param("every 1 days 1 hours 30 minutes 30 seconds", TaskStarted(period=TimeDelta("every 1 days 1 hours 30 minutes 30 seconds")) == 0, id="every hour 30 mins 30 seconds"),
