...
@pytest.mark.parametrize("dt,expected_left,expected_right", [
    ...
    ("2020-06-02 23:59:59.999999", "2020-06-02 00:00", "2020-06-02 23:59:59.999999"), 
...
@pytest.mark.parametrize("dt,expected_left,expected_right", [
    # Inside
    ("2020-06-02 12:00", "2020-06-02 12:00", "2020-06-02 23:59:59.999999"), 
    ("2020-06-02 00:00", "2020-06-02 00:00", "2020-06-02 23:59:59.999999"), 
    ("2020-06-02 23:59:59.999999", "2020-06-02 23:59:59.999999", "2020-06-02 23:59:59.999999"), 
], ids=["In interval", "In interval, left", "In interval, right"])
...
@pytest.mark.parametrize("dt,expected_left,expected_right", [
    ...
    ("2020-06-02 23:59:59.999999", "2020-06-01 00:00", "2020-06-02 23:59:59.999999"), 
], ids=["In interval", "In interval, left", "In interval, right"])
...
@pytest.mark.parametrize("dt,expected_left,expected_right", [
    ...
    ("2020-06-02 23:59:59.999999", "2020-06-02 23:59:59.999999", "2020-06-03 23:59:59.999999"), 
], ids=["In interval", "In interval, left", "In interval, right"])
