...
DEFAULT_BASENAME_TASKS = "atlas.task"
DEFAULT_BASENAME_SCHEDULER = "atlas.scheduler"
...
def _rename_basenames(loggers:dict, task_basename, scheduler_basename):
    """Rename all loggers that start with 'atlas.task' and atlas.scheduler
